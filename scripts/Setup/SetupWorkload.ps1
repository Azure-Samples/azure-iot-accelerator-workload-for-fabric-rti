...
.DESCRIPTION
    ...
    - AAD application configuration for authentication
...
.PARAMETER FrontendAppId  
    AAD Application ID for the frontend (you will be prompted if it is not provided)
...
if ([string]::IsNullOrWhiteSpace($FrontendAppId) -or $FrontendAppId -eq "00000000-0000-0000-0000-000000000000") {
    ...
    Write-Host "Create the application by following docs/create-entra-app.md."
...
Write-Host "These generated files are ignored by git and should not be committed."
